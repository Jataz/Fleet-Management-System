...
from .views import FuelDisbursementCreate, FuelDisbursementDetail, FuelDisbursementList, LocationAPIView, MaintenanceClose,\
    ...
    FuelReceivedList,MonthlyAllocationAPIView
...
urlpatterns = [
    ...
    path('vehicle-maintenance-create/', VehicleMaintenanceCreate.as_view(), name='vehicle-maintenance-create'),
    ...
    path('monthly-allocation/', MonthlyAllocationAPIView.as_view(), name='monthly-allocation'),
